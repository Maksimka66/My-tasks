...
// Таска 12. Крокетний клуб Western Suburbs має дві категорії членства: старше та відкрите. Їм потрібна ваша допомога з аплікаційною формою, у якій потенційним членам буде вказано, до якої категорії вони будуть призначені. Щоб бути старшим, член повинен бути не менше 55 років і мати гандикап більше 7. У цьому крокетному клубі гандикап коливається від -2 до +26; чим кращий гравець, тим нижчий гандикап. 1) Введення: Вхідні дані складатимуться зі списку пар. Кожна пара містить інформацію про одного потенційного члена. Інформація складається з цілого числа для віку людини та цілого числа для вади людини. 2) Вихід: Вихідні дані складатимуться зі списку рядкових значень (у Haskell і C: Open або Senior), які вказуватимуть, чи буде відповідний член поміщений у старшу чи відкриту категорію.
...
// Таска 13. Ваше завдання — написати функцію, яка повертає n-й член наступного ряду, який є сумою перших n членів послідовності (n — вхідний параметр). Щоб завершити це, вам потрібно буде з’ясувати правило ряду. Правила: Вам потрібно округлити відповідь до 2 знаків після коми та повернути її як рядок. Якщо дане значення дорівнює 0, воно має повернути "0,00". Вам будуть надані лише натуральні числа як аргументи.
